  ...
  (setq-default
   ...
   '(rust
     ...
     (cmake :varibles cmake-enable-cmake-ide-support
            t cmake-ide-build-pool-use-persistent-nameing
            t cmake-ide-build-pool-dir 'build)
     gpu
     ;; ----------------------------------------------------------------
...
(custom-set-variables
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(package-selected-packages (quote (yapfify ws-butler winum which-key volatile-highlights
